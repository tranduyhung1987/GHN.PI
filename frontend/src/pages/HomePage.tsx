...
const HomePage: React.FC<HomePageProps> = ({ onNavigate }) => {
  ...
  return (
    <div style={pageContainer}>
      ...
      {/* 6 THẺ CHÍNH - LUÔN HIỂN THỊ ĐỂ QUẢNG BÁ DAPP (kể cả khi chưa chọn vai trò) */}
      <div style={cardsGrid}>
